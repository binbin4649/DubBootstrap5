<footer class="bg-light p-3 mt-4 p-md-5 mt-md-5 border-top small">
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="row">
                <div class="col-4">
                    <?php $this->BcBaser->img('24x24.png', ['width' => '24', 'height' => '24', 'class' => 'mb-2', 'alt' => 'logo mini image']) ?>
    ...
    <div class="text-center mt-3 mt-md-5">
        <a href="http://basercms.net/" target="_blank">
            <?php $this->BcBaser->img('baser.power.gif', ['class' => 'border-0 me-1', 'alt' => 'baserCMS : Based Website Development Project']) ?>
        </a>
        <a href="http://cakephp.org/" target="_blank">
            <?php $this->BcBaser->img('cake.power.gif', ['class' => 'border-0', 'alt' => 'CakePHP(tm) : Rapid Development Framework']) ?>
        </a>
        <a href="http://dubmilli.com/" target="_blank">
            <?php $this->BcBaser->img('dubmilli.power.gif', ['class' => 'border-0 ms-1', 'alt' => '合同会社ダブミリ dubmilli LLC.']) ?>
        </a>
    </div>
</footer>